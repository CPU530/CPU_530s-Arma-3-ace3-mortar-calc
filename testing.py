...
def radial(charge0, charge1, charge2):
    ...
    while len(Target_bearing) != 4 and len(Target_bearing) != 3:
        print("=" * 90)
    ...
    """
    add correction if azi,uth values is greater than 360 adn 6400 via logical check  of something to the effect of ( int(Target_bearing) > 6400)
    """
    while int(Target_bearing) > 6400 and len(Target_bearing) == 4:
        print("=" * 90)
        print("ERROR: You did not enter a valid input")
        Target_bearing = str(
            input(
    ...
    while int(Target_bearing) > 360 and len(Target_bearing) == 3:
        print("=" * 90)
        print("ERROR: You did not enter a valid input")
        Target_bearing = str(
            input(
...
def interface_functions():
    ...
    while len(global_mortar_pos) % 2 == 1 or not global_mortar_pos.isnumeric():
        print("=" * 90)
        print("ERROR: You did not enter a valid input")
        print("The length of the gridmark cannot be odd and it cannot contain non-numeric characters.")
        global_mortar_pos = str(input("re-Enter the Grid position of your gun team: "))
