...
def main():
    ...
    air_density = ((pressure * 100 - humidity * 610.78 * 10 ** ((7.5 * temperature) / (temperature + 237.3))) * 0.028964 + humidity * 610.78 * 10 ** ((7.5 * temperature) / (temperature + 237.3)) * 0.018016) / (8.314 * (temperature + 273.15))
  ...
  #  hWindSpeed
   ...
   # temp
    ...
    if  charge0Truth == 1:
        print (f' [ Charge 0 Near Elevation:{nearEL0}, Far Elevation:{farEL0}] Average Elevation for Charge 0 {avgelevation0}')
    else:
        print(' Charge 0 is invalid')
    if  charge1Truth == 1:
        print (f' [ Charge 1 Near Elevation:{nearEL1}, Far Elevation:{farEL1}] Average Elevation for Charge 1 {avgelevation1}')
    else:
        print(' Charge 1 is invalid')

    if  charge2Truth == 1:
        print (f' [ Charge 2 Near Elevation:{nearEL2}, Far Elevation:{farEL2}] Average Elevation for Charge 2 {avgelevation2}')
    else:
